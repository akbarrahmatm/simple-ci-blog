        ...
        <div class="col-8">
            <form action="/admin/blog/save" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" class="form-control <?= $error->hasError('judul') ? "is-invalid" : false ?>" value="<?= old('judul') ?>" id="judul">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select <?= $error->hasError('category') ? "is-invalid" : false ?>" name="category">
                        ...
                        <?php foreach ($category as $dataCategory) : ?>
                            <option <?= old('category') == $dataCategory['category_id'] ? "selected" : false ?> value="<?= $dataCategory['category_id'] ?>"><?= $dataCategory['category'] ?></option>
                        <?php endforeach ?>
                    </select>
                    <div id="judulValidation" class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control <?= $error->hasError('content') ? "is-invalid" : false ?>" name="content" id="content"><?= old('content') ?></textarea>
                    <div id="judulValidation" class="invalid-feedback">
